const HOMEPAGE_DEFAULTS = {
  ...
  capabilities: {
    ...
    title: 'What We Do',
    description: 'From concept to implementation, we deliver comprehensive solutions that drive real value.',
    items: [
  ...
  detailed_services: {
    eyebrow: 'OUR DETAILED SERVICES',
    title: 'In-Depth Solutions',
    description: 'Comprehensive details about the core services we offer to transform your business.',
    items: [
  ...
  track_record: {
    ...
    description: 'Numbers that speak to our commitment to excellence and innovation.',
    stats: [
      { value: 50, label: 'Prototypes Built', suffix: '+' },
      { value: 20, label: 'Collaborative Solutions', suffix: '+' },
      { value: 5, label: 'Sustainable Solutions', suffix: '+' },
      { value: 95, label: 'Customer Retention Rate', suffix: '%' }
    ]
  },
...
module.exports = { HOMEPAGE_DEFAULTS };
